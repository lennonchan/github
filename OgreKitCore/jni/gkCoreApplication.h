...
protected:
	...
	gkString m_ResZipPath;
	gkResourceName m_AppResName;
...
public:
	...
	// add by dabao 2013-01-14  add zip data
	void addZipDataPath(gkString zipPath,gkResourceName resoureName);

    // add by dabao 2013-01-17 add res data path
    void addResourceDataPath(gkString resPath);
