...
// add by dabao Test 2012.07.13 texture blend-----------------------------
enum SourceForm
{
	GK_BT_Current = 0x0,
	GK_BT_Texture,
...
// end --------------------------------------------------------------------
class gkTextureProp2OgreProxy
{
public:
	struct Channel 
	{
		Channel() : blendType(GK_BT_MODULATE),soruce0(GK_BT_Texture),
			soruce1(GK_BT_Current),use_channel(false)
		{}
		OgreType blendType;
		SourceForm soruce0;
		SourceForm soruce1;
		TextureChannl channel;
		bool use_channel;
	};
	gkTextureProp2OgreProxy()
	{
		AlpahChannel.channel = GK_BT_Alpha;
		ColorChannel.channel = GK_BT_Color;
	}
	Channel AlpahChannel;
...
public:
	...
	gkTextureProp2OgreProxy m_Ogre;
};
