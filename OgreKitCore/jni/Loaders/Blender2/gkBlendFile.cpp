...
{	
	...
	//LogManager::getSingleton().logMessage("parse beigne");
	m_findScene = scene;
	...
	//LogManager::getSingleton().logMessage("parse end");
...
void gkBlendFile::loadActive(void)
{
	...
	LogManager::getSingleton().logMessage("loadActive beigne");
...
void gkBlendFile::createInstances(void)
{
	...
	//LogManager::getSingleton().logMessage("createInstances beigne");
	...
	while (iter.hasMoreElements())
	{
		...
		{	
			...
			//LogManager::getSingleton().logMessage("createInstances m_findScene  -----1");
	...
	//LogManager::getSingleton().logMessage("createInstances end  -----1");
	...
	//LogManager::getSingleton().logMessage("createInstances end  -----2");
	...
	//LogManager::getSingleton().logMessage("createInstances end");
}
