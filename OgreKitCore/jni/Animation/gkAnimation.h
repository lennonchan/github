...
public:
	...
	UT_INLINE akScalar         getStartFrame(void) const       { return m_animation.getStartFrame(); }
	UT_INLINE void             setStartFrame(akScalar v)       { m_animation.setStartFrame(v); }
	UT_INLINE akScalar         getEndFrame(void) const       { return m_animation.getEndFrame(); }
	UT_INLINE void             setEndFrame(akScalar v)       { m_animation.setEndFrame(v); }
...
public:
	enum gkTransformChannelCodes
	{
		...
		//add channel    zy
		SC_ALPHA,                         //alpha
		SC_DIFFUSE_COLOR_R,    //diffuse color
		SC_DIFFUSE_COLOR_G,
		SC_DIFFUSE_COLOR_B,
		SC_TEXTURE0_OFFSET_X,  // texture matrix offset
		SC_TEXTURE0_OFFSET_Y,
		SC_TEXTURE0_OFFSET_Z,
		SC_TEXTURE1_OFFSET_X,  // texture matrix offset
		SC_TEXTURE1_OFFSET_Y,
		SC_TEXTURE1_OFFSET_Z,
		SC_TEXTURE0_ALPHA_FACTOR,
		SC_TEXTURE1_ALPHA_FACTOR,
		SC_TEXTURE0_DIFFUSE_COLOR_FACTOR,
		SC_TEXTURE1_DIFFUSE_COLOR_FACTOR,
		SC_IMAGE_FRAME,  // texture frame
	};
