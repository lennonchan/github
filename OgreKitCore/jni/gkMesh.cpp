...
gkSubMesh* gkSubMesh::clone(void)
{
	...
	//nme->m_material         = m_material;           // delete clone by dabao 2012-7-8
...
gkBlendFile2Ogre* gkBlendFile2Ogre::OgreMaterai = new gkBlendFile2OgreImpl();

utHashTable<gkHashedString,gkBlendFile2OgreImpl::Material> gkBlendFile2OgreImpl::Materials;